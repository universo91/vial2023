        ...
        <fieldset class="form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9">
                        <input maxlength="40" type="text" class=" form-control form-control-sm" name="numero_tramo" id="numero_tramo" value="" >
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9">
                        <input maxlength="40" type="text" class=" form-control form-control-sm" name="progresiva_inicial" id="progresiva_inicial" value="" >
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9">
                        <input maxlength="40" type="text" class=" form-control form-control-sm" name="progresiva_final" id="progresiva_final" value="" >
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9">
                        <input maxlength="40" type="text" class=" form-control form-control-sm" name="coor_x_inicial" id="coor_x_inicial" value="" >
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9">
                        <input maxlength="40" type="text" class=" form-control form-control-sm" name="coor_y_inicial" id="coor_y_inicial" value="" >
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9">
                        <input maxlength="40" type="text" class=" form-control form-control-sm" name="altitud_inicial" id="altitud_inicial" value="" >
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9">
                        <input maxlength="40" type="text" class=" form-control form-control-sm" name="coor_x_final" id="coor_x_final" value="" >
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9">
                        <input maxlength="40" type="text" class=" form-control form-control-sm" name="coor_y_final" id="coor_y_final" value="" >
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9">
                        <input maxlength="40" type="text" class=" form-control form-control-sm" name="altitud_final" id="altitud_final" value="" >
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9">
                        <input maxlength="40" type="text" class=" form-control form-control-sm" name="punto_notable" id="punto_notable" value="" >
                    </div>
                </div>
            </div>
            ...
            <div class="form-group ">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9">
                        <input maxlength="40" type="text" class=" form-control form-control-sm" name="tramo_inicio" id="tramo_inicio" value="" >
                    </div>
                </div>
            </div>
            ...
            <div class="form-group >
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9">
                        <input maxlength="40" type="text" class=" form-control form-control-sm" name="tramo_fin" id="tramo_fin" value="" >
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9">
                        <input maxlength="40" type="text" class=" form-control form-control-sm" name="ancho_calzada" id="ancho_calzada" value="" >
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9">
                        <input maxlength="40" type="text" class=" form-control form-control-sm" name="ancho_berma_izquierda" id="ancho_berma_izquierda" value="" >
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9">
                        <input maxlength="40" type="text" class=" form-control form-control-sm" name="ancho_berma_derecha" id="ancho_berma_derecha" value="" >
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9">
                        <input maxlength="40" type="text" class=" form-control form-control-sm" name="observaciones" id="observaciones" value="" >
                    </div>
                </div>
            </div>
