...
class CreateTramosTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('tramos', function (Blueprint $table) {
            ...
            $table->string('ancho_plataforma');
            $table->string('progresiva');
            $table->string('coor_x_inicial', 10, 2)->nullable();
            $table->string('coor_y_inicial', 10, 2)->nullable();
            $table->string('altitud_inicial')->nullable();
            $table->string('coor_x_final', 10, 2);
            $table->string('coor_y_final', 10, 2);
            $table->string('altitud_final');
            $table->string('zona');
            ...
            $table->decimal('ancho_berma_izquierda', 2, 2);
            $table->decimal('ancho_berma_derecha', 2, 2);
